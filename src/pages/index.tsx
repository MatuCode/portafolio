...
/* Local fallback for ContactSection */
function ContactSection() {
  ...
  const t = {
    es: {
      title: "Contacto",
      description: "Puedes contactarme por correo o LinkedIn.",
      email: "Enviar correo",
      linkedin: "LinkedIn",
    },
    en: {
      title: "Contact",
      description: "You can reach me via email or LinkedIn.",
      email: "Send email",
      linkedin: "LinkedIn",
    },
  }[lang];
  ...
  return (
    <section className="min-h-screen flex items-center" aria-label="Contacto / Contact">
      <div className="w-full max-w-[1200px] pl-6 md:pl-16 lg:pl-28 xl:pl-40 pr-6">
        <h2 className="text-3xl md:text-4xl font-bold text-white drop-shadow">{t.title}</h2>
  ...
  const t = {
    es: {
      ...
      titles: [
        ...
        "Máster en Desarrollo de Software (en proceso)",
      ],
      blurb:
    ...
    en: {
      ...
      titles: [
        ...
        "Master's in Software Development (in progress)",
      ],
      blurb:
...
const projectsES: Project[] = [
  {
    ...
    github: "https://github.com/Matucode", // si es privado, déjalo o quítalo
    demo: "#",
  },
  {
    id: "futurity",
  ...
  },
  {
    ...
    title: "Portfolio Web",
    description:
      "Portafolio personal con animaciones y secciones dinámicas.",
...
const projectsEN: Project[] = [
  ...
  },
  {
    ...
    title: "Futurity Inventory",
    description:
      "Inventory and service quality system for an ISP. Implemented for a real company.",
    image: "/projects/futurity.jpg",
    tags: ["Java", "TypeScript", "SQL", "Spring Boot", "React"],
    github: "https://github.com/Matucode",
  },
  ...
  },
  {
    ...
    description:
      "Personal portfolio with smooth animations and dynamic sections.",
    image: "/projects/portfolio.jpg",
    tags: ["TypeScript", "JavaScript", "CSS", "Next.js", "Tailwind", "Framer Motion"],
    github: "https://github.com/Matucode",
    demo: "/",
